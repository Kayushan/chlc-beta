...
import { LogOut, GraduationCap, BrainCog } from 'lucide-react'
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <nav className="flex items-center space-x-2 sm:space-x-4">
              ...
              {['admin', 'creator', 'head', 'teacher'].includes(user?.role) && (
                <Link
                  to="/ai"
                  className={darkMode ? 'flex items-center text-xs sm:text-sm text-purple-400 hover:underline font-medium px-2 py-1 rounded transition-colors hover:bg-purple-900/20' : 'flex items-center text-xs sm:text-sm text-purple-600 hover:underline font-medium px-2 py-1 rounded transition-colors hover:bg-purple-50'}
                >
                  <BrainCog className="h-4 w-4 sm:mr-1" />
                  AI
                </Link>
              )}
