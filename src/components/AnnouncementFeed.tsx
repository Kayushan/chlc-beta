...
import { deleteAnnouncement, updateAnnouncement } from '../lib/announcementManagement';
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-md">
            ...
            <form onSubmit={handleUpdate}>
              ...
              <div className="flex justify-end gap-2">
                <button type="button" onClick={() => setEditingAnnouncement(null)} className="px-3 py-1 rounded bg-gray-200 text-gray-700">Cancel</button>
                <button type="submit" className="px-3 py-1 rounded bg-blue-600 text-white hover:bg-blue-700">Update</button>
              </div>
            </form>
          </div>
        </div>
